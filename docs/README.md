...
| [CENTER_ONLY_ABLATION.md](CENTER_ONLY_ABLATION.md) | 本分支参数、验证及运行命令 |
...
| 项目 | 当前状态 |
| --- | --- |
| 当前 Git 分支 | `codex/proposal-center-only`（已推送 origin） |
| 分支起点 / 算法提交 | `dev@cec9362` / `f1af868`；实际 HEAD 见 `git rev-parse HEAD` |
