    ...
    *,
    ...
    supported_values = {
        ...
        "region.scaler.type": (
            ...
            {"adaptive_gt_scaler_v3", "midpoint_center_only"},
        ),
        "region.value.type": (
    ...
    if config.region.scaler.enabled and config.region.scaler.type == "midpoint_center_only":
        _require(
            ...
            "midpoint_center_only requires B1 matching/value and per_gt_gaussian",
            errors,
        )
