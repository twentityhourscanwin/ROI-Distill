# A4: ROI Classification only — 全通道蒸馏 + ROI 质量分类掩码 (无 Channel-Split, 无 Adaptive Scaling)
# 双帧 (key_idxes=[-2])，使用 LabelDistillFull 模型（全通道蒸馏）+ ROI 掩码
# 验证 ROI Classification 不依赖 Channel-Split 的独立贡献
