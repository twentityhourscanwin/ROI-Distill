# labeldistill/exps/nuscenes/labeldistill/LidarDistill_r50_128x128_e24_roi_v3.py
...
class LabelDistillModel(BaseLabelDistillModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.generate_bev_mask = QualityAwareMaskGeneratorV3(
            w_l=0.4, w_h=0.7, r_max=50.0, boost_small_medium=True)
...
if __name__ == '__main__':
    run_cli(LabelDistillModel,
            'LidarDistill_r50_128x128_e24_roi_v3',
