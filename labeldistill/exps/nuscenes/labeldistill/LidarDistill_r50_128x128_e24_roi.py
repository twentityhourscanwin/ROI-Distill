#labeldistill/exps/nuscenes/labeldistill/LidarDistill_r50_128x128_e24_roi.py
# 消融实验 C: ROI mask蒸馏 + 通道分割，无FP蒸馏
# 对比 Lidar_gt_label_r50_128x128_e_24 (GT mask) 可证明 ROI mask 优于 GT mask
# 对比 LidarDistill_r50_128x128_e24_4keyfp       可证明 FP蒸馏的增益
...
if __name__ == '__main__':
    run_cli(LabelDistillModel,
            'LidarDistill_r50_128x128_e24_roi',
