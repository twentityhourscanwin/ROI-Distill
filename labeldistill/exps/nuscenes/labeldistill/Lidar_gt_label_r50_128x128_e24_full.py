#labeldistill/exps/nuscenes/labeldistill/Lidar_gt_label_r50_128x128_e24_full.py
# 与 Lidar_gt_label_r50_128x128_e_24.py 的区别：
# 不对学生 backbone 输出做通道切分，全部通道送入 adaptor 蒸馏
...
class LabelDistillModel(BaseLabelDistillModel):
    ...
    def training_step(self, batch):
        ...
        lidar_distill_loss = self.get_feature_distill_loss(lidar_feats, distill_feats_lidar, targets[0], binary_mask=False) * 0.6
    ...
    def configure_optimizers(self):
        optim_wrapper_cfg = dict(
            ...
            optimizer=self.optimizer_config.get('optimizer', dict(
                type='AdamW',
                lr=self.optimizer_config.get('lr', 4e-4),
...
if __name__ == '__main__':
    run_cli(LabelDistillModel,
            'Lidar_gt_label_r50_128x128_e24_full',
