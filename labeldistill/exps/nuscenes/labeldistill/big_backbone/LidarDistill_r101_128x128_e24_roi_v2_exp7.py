# ResNet101 512x1408 + ROI-v2 Exp7配置
# 基于 exp7 最优设置: tau_ratio=0.3 + base_expand=0.1 + medium_expand=0.15 + boost_small_medium
# 验证 v2+exp7 在 ResNet101 大 backbone 上的泛化性
from labeldistill.exps.base_cli import run_cli
from labeldistill.exps.nuscenes.base_exp_res101 import \
...
class LabelDistillModel(BaseLabelDistillModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.generate_bev_mask = QualityAwareMaskGenerator(w_l=0.7, w_u=0.3, r_max=50.0, boost_small_medium=True)
        self.proposal_target_layer = ProposalTargetLayer(roi_sampler_cfg=roi_sampler_cfg)
        self.change_gt = AdaptiveGTScalerV2(tau_ratio=0.3, s_vel=0.2, r_max=50.0, base_expand_ratio=0.1, medium_expand_ratio=0.15)
...
if __name__ == '__main__':
    run_cli(LabelDistillModel,
            'LidarDistill_r101_128x128_e24_roi_v2_exp7',
